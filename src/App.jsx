...
const LandingPage = () => {
  emailjs.init("r8NIXKlDYeHO6bBvI");
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.name || !form.company || !form.phone) {
      alert(
        "Пожалуйста, заполните все обязательные поля (Имя, Компания, Телефон)",
      );
      return;
    }
    ...
    try {
     ...
     (error) {
      ...
      alert(
        `❌ Ошибка при отправке заявки.\n\nДетали: ${error.text || error.message || "Неизвестная ошибка"}`,
      );
    } finally {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <select
                ...
                value={form.service}
                onChange={handleChange}
                className="w-full p-3 bg-gray-50 border-[#E5E7EB] rounded-2xl text-gray-500 outline-none"
              >
                <option value="">Выберите услугу...</option>
                <option value="IT-инфраструктура">IT-инфраструктура</option>
                <option value="Информационная безопасность">
                  Информационная безопасность
                </option>
                <option value="Цифровая трансформация">
                  Цифровая трансформация
                </option>
                <option value="On-Site Решения">On-Site Решения</option>
            ...
            <div className="flex flex-col gap-y-2.5">
              <button
                ...
                className="w-full bg-[#4f46e5] text-white py-4 rounded-2xl font-bold hover:bg-blue-700 cursor-pointer transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
              >
